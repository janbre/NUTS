...
/** Make use of reserved flag for sequence number**/
#define CSP_SEQNR			0x80 				// Use to add sequence number
...
/** Need a socket option for the use of sequence numbers */
#define CSP_SO_SEQNR		0x0200				// Enable use of sequence numbers on uplink
...
/** Need a connection option for the use of sequence numbers */
#define CSP_O_SEQNR			CSP_SO_SEQNR		// Enable SEQNR
